...
// inline bool ReadProtoFromTextFile(Message* proto) {
  // return ReadProtoFromTextFile(proto);
// }

bool ReadProtoFromBinaryFile(Message* proto);

// inline bool ReadProtoFromBinaryFile(Message* proto) {
  // return ReadProtoFromBinaryFile(proto);
// }
